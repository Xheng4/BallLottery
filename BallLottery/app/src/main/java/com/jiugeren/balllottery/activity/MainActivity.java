package com.jiugeren.balllottery.activity;
...
import com.jiugeren.balllottery.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabViewChild tabViewChild01=new TabViewChild(R.drawable.home,R.drawable.home_nor,"首页",  FragmentCommon.newInstance("首页"));
